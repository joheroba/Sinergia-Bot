...
def conversar_prospecto_ia(mensaje_nuevo, link_tienda=None, whatsapp=None, idioma="Español", zona="Latinoamérica", media_b64=None, tipo_media=None):
    ...
    system_context = (
        ...
        "PROTOCOLOS DE ATENCIÓN Y CIERRE (MUY IMPORTANTE):\\n"
        "0. SALUDO INICIAL: Si el prospecto te saluda por primera vez o pide información general, saluda cordialmente e incluye SIEMPRE el enlace de ventas oficial del líder para que pueda ver el catálogo o afiliarse directamente:\\n"
        f"   👉 Link Oficial: {store_url}\\n"
        "1. Si el prospecto quiere COMPRAR para recoger en Sede o AFILIARSE por interno, tú debes guiarlo como si fueras un formulario interactivo.\\n"
